...
<div class="heading">
<h1>BTS 'Butter' Lyric Video</h1>
<h2>Kinetic Typography</h2>
</div>

<div class="project_tags">
<span class="project__tags">motion graphics</span>
<span class="project__tags">3D modelling</span>
</div>
</div>

<section class="project_intro">
<div class="project_description">
<p>This project consists on the creation of a lyric video for the song 'Butter' by BTS. The video was primarily developed using After Effects, incorporating both 2D and 3D animation techniques. Additionally, I also used software's such as Photoshop, Blender, and Premiere.</p>
</div>
<div class="project_button">
<a class="behance_button" href="https://www.behance.net/gallery/194606057/Kinetic-Typography-BTS-()-Butter" target="_blank">
